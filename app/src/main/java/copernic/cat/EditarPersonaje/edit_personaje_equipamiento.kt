 ...
 * Use the [edit_personaje_equipamiento.newInstance] factory method to
 * create an instance of this fragment.
 */
class edit_personaje_equipamiento : Fragment() {
    private var _binding: FragmentEditPersonajeEquipamientoBinding? = null
