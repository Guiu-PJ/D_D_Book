...
import copernic.cat.databinding.FragmentReaccionBinding
 ...
 */
class reaccion : Fragment() {
    private var _binding: FragmentReaccionBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnFlechaReaccion.setOnClickListener{
            findNavController().navigate(R.id.action_reaccion_to_reglas)
        }
