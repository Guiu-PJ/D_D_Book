 ...
 */
class dotes : Fragment() {
    private var _binding: FragmentDotesBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnFlechaDotes.setOnClickListener{
            findNavController().navigate(R.id.action_dotes_to_reglas)
        }
